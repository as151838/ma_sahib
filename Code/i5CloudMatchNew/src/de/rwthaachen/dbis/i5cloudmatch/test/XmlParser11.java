...
public class XmlParser11 {
      ...
      public static class Reduce extends Reducer<Text, Text, Text, Text> {
    	  ...
    	  public static String constructPropertyXml(Text author, Text title) {
    		  StringBuilder sb = new StringBuilder();
    		  sb.append("<inproceedings><author>").append(author)
    		    .append("</author><title>").append(title)
    		    .append("</title></inproceedings>");
    		  return sb.toString();
    	  }
      }
