...
public class DBLPInproceedingXMLProcessorWorking {
      ...
      public static class Reduce extends Reducer<Text, Text, Text, Text> {
    	  ...
    	  public void oeduce(Text key, Iterable<Text> values, Context context)
                throws IOException, InterruptedException {
      ...
      public static void main(String[] args) throws Exception {
              ...
              job.setJarByClass(DBLPInproceedingXMLProcessorWorking.class);
              job.setOutputKeyClass(Text.class);
              job.setOutputValueClass(Text.class);

              job.setMapperClass(DBLPInproceedingXMLProcessorWorking.Map.class);
              job.setReducerClass(DBLPInproceedingXMLProcessorWorking.Reduce.class);
