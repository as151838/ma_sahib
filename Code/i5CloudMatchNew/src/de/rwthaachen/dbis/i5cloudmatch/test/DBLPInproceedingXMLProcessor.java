...
import de.rwthaachen.dbis.i5cloudmatch.test.RBC.NeighborRBC;
    				  	...
    				  	case XMLStreamConstants.CHARACTERS: 
    				  		...
    				  		if (currentElement.equalsIgnoreCase("inproceedings") &&
    							...
    							for (int i=0;i<tempRbcs.size();i++) {
    								...
    								context.write(new Text(String.valueOf("")), new Text(tempRbcs.get(i).serialize()));
    								System.out.println(tempRbcs.get(i).serialize());
    							}
