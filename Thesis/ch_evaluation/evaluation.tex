...
\section{Measuring Framework Efficiency}
Average Message Transferred
Communication Complexity: The communication complexity, denotes the communication cost,i. e., the total number of bits exchanged in all messages across the machines during a computation\cite{WoZh13}.
Round Complexity: The round complexity refers to the number of communication rounds needed for the computation, given various constraints on what messages can be sent by each machine in each round\cite{WoZh13}.
